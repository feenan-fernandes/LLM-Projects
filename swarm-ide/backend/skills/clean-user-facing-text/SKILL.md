...
read eferences/writing-in-your-voice.md whenever the user asks to retain or adjust voice.
...
For technical background, read eferences/watermark-notes.md. For misuse or disclosure questions, read eferences/responsible-use.md.
