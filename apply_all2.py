...
# First we isolate the body of _stream()
...
# Indent the old body by 4 spaces
indented_body = ""
for line in body.splitlines():
    indented_body += "    " + line + "\\n"

# Replace the run_builder_loop and stream_orchestrator calls in the indented body to pass abort_evt
